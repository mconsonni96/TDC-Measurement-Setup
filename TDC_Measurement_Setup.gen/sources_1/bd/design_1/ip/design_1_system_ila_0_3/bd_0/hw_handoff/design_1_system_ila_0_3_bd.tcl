...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_AXI_ARUSER_WIDTH {4} \
   CONFIG.C_SLOT_0_AXI_AR_SEL {1} \
   CONFIG.C_SLOT_0_AXI_AWUSER_WIDTH {4} \
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net net_slot_0_axi_aruser [get_bd_pins g_inst/m_slot_0_axi_aruser] [get_bd_pins ila_lib/probe8]
  ...
  connect_bd_net -net net_slot_0_axi_awsize [get_bd_pins g_inst/m_slot_0_axi_awsize] [get_bd_pins ila_lib/probe16]
  connect_bd_net -net net_slot_0_axi_awuser [get_bd_pins g_inst/m_slot_0_axi_awuser] [get_bd_pins ila_lib/probe17]
